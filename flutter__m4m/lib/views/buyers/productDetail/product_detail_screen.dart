...
import 'package:flutter__m4m/utils/show_snackBar.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                '\$' +
                    ' ' +
                    double.parse(widget.productData['productPrice']).toDouble().toStringAsFixed(2),
                style: TextStyle(
                  fontSize: 22,
                  letterSpacing: 8,
                  fontWeight: FontWeight.bold,
            ...
            ExpansionTile(
              title: Row(
                ...
                children: [
                  Text(
                    'Product Description',
                    style: TextStyle(color: Color.fromARGB(255, 164, 0, 0)),
                  ),
                  Text(
                    'View More',
                    style: TextStyle(color: Color.fromARGB(255, 164, 0, 0)),
              ...
              : () {
                  if (_selectedSize == null) {
                    ...
                    _cartProvider.addProductToCart(
                        ...
                        1,
                        int.parse(widget.productData['quantity']),
                        double.parse(widget.productData['productPrice']),
